...
const reportTypeEnum = pgEnum('report_type', ['ingestion', 'comment_analysis', 'pr_analysis']);
const reportStatusEnum = pgEnum('report_status', ['in_progress', 'completed', 'failed']);
