    ...
    <div className="w-full flex flex-col justify-center items-center gap-2">
      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(255,255,255,0.1)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(0,0,0,0.3)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          {/* Pricing Badge */}
          <div className="px-[14px] py-[6px] bg-[#1a1a1a] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.05)] overflow-hidden rounded-[90px] flex justify-start items-center gap-[8px] border border-[rgba(255,255,255,0.15)] shadow-xs">
