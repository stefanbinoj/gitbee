    ...
    <div className="space-y-6">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-green-500 mt-1">-0.5s from last week</p>
              </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3 bg-neutral-900 border-neutral-700">
          <CardHeader>
            <CardTitle className="text-sm font-medium text-neutral-300 tracking-wider">RESPONSE RATE</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              {/* Success Rate */}
              <div className="space-y-2">
                ...
                <div className="w-full bg-neutral-800 rounded-full h-3">
                  <div className="bg-green-500 h-3 rounded-full transition-all duration-500" style={{ width: "94.2%" }}></div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-neutral-800 rounded-full h-3">
                  <div className="bg-yellow-500 h-3 rounded-full transition-all duration-500" style={{ width: "78.5%" }}></div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-neutral-800 rounded-full h-3">
                  <div className="bg-yellow-500/70 h-3 rounded-full transition-all duration-500" style={{ width: "91.8%" }}></div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-neutral-800 rounded-full h-3">
                  <div className="bg-green-500 h-3 rounded-full transition-all duration-500" style={{ width: "99.9%" }}></div>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-yellow-500">Performance Tip</p>
                  <p className="text-xs text-neutral-400 mt-1">
                    Add more documentation to your knowledge base to improve GitBee's response accuracy by up to 40%.
                  </p>
                </div>
              </div>
            </div>
